const modal = {
    ...
    init() {
        this.thumb_front_img.addEventListener('click', this._showThumbFront.bind(this));
        this.thumb_back_img.addEventListener('click', this._showThumbBack.bind(this));
    },
    ...
    open(options) {
        ...
        document.getElementById("cards__img-tmpl").setAttribute("src", "images/" + options.mphoto);
        document.getElementById("thumb__front-tmpl").setAttribute("src", "images/" + options.mphoto);
        document.getElementById("thumb__back-tmpl").setAttribute("src", "images/" + options.mphoto_b);
